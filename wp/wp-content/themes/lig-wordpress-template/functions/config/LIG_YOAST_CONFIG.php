...
class LIG_YOAST_CONFIG
{
    ...
    public function __construct()
    {
        ...
        //一般設定
        $this->front_page_title = '株式会社LIG公式サイト';
        $this->site_description = '株式会社LIGのWEBサイトです';
        $this->site_title = '株式会社LIG';
        $this->separator = '｜';
        $this->not_found_title = 'Page not Found';
        ...
        $this->post_type = [
            'default' => [
                'single-title' => "%%title%%" . $this->separator . $this->site_title,
                'archive-title' => "%%pt_plural%%" . $this->separator . $this->site_title,
                'metadesc' => $this->site_description,
            ],
            'news' => [
                'single-title' => "%%title%%" . $this->separator . $this->site_title,
                'archive-title' => "%%pt_plural%%" . $this->separator . $this->site_title,
            ...
            'case' => [
                'single-title' => "%%pt_plural%%" . $this->separator . $this->site_title,
                'archive-title' => "事例" . $this->separator . $this->site_title,
                'metadesc' => '事例一覧の説明文です'
            ],
        ];
        ...
        $this->taxonomy = [
            'default' => [
                'title' => "%%term_title%%" . $this->separator . $this->site_title,
                'metadesc' => $this->site_description,
            ],
            'news-category' => [
                'title' => "%%term_title%%" . $this->separator . $this->site_title,
        ...
        $this->option_wpseo_titles = [
            "title-home-wpseo" => $this->front_page_title,
            "website_name" => $this->site_title, //サイト名
            "alternate_website_name" => $this->site_title, //サイト名
            "title-page" => "%%title%%" . $this->separator . $this->site_title,//固定ページのタイトル
            "title-post" => "%%title%%" . $this->separator . $this->site_title,//記事詳細ページのタイトル
            "title-404-wpseo" => $this->not_found_title . $this->separator . $this->site_title, //404ページのタイトル
            "title-search-wpseo" => "「%%searchphrase%%」の検索結果" . $this->separator . $this->site_title, //検索ページのタイトル
            "forcerewritetitle" => true,//titleタグ強制書き換え
            "metadesc-home-wpseo" => $this->site_description,
            ...
            "breadcrumbs-404crumb" => $this->not_found_title, // パンクずの404
        ...
        $this->option_wpseo_social = [
            ...
            "og_default_image_id" => "",
            "og_frontpage_title" => $this->front_page_title,
            "og_frontpage_desc" => $this->site_description,
